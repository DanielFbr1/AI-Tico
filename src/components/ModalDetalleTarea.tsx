                                ...
                                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pl-16 pr-4 md:pl-20">
                                    ...
                                    <div className="flex items-center gap-3 py-1">
                                        ...
                                        <div className="flex items-center gap-2">
                                             <span className="text-[10px] font-black text-slate-400 bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full uppercase tracking-widest border border-white/30 text-white/90">Versión V6.7.2</span>
                                            <button 
                                                onClick={onClose}
